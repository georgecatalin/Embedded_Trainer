...
{
    outputStream<<"real part ="<<complexNumber.real_part<<" imaginary part="<<complexNumber.imaginary_part<<endl;
    return outputStream;
}
...
{
    inputStream>>complexNumber.real_part>>complexNumber.imaginary_part;
    return inputStream;
}